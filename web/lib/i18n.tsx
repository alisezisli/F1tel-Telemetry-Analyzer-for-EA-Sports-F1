...
const translations = {
  ...
  tr: {
    ...
    description:
      "Oturumlarını Windows masaüstü uygulamasıyla kaydet. .f1tel dosyasını buraya yükleyerek tur süreleri, sektör zamanları, hız izleri, lastik sıcaklıkları, stint karşılaştırmaları ve daha fazlasını keşfet. Her şey tarayıcında işlenir - verilerin cihazından çıkmaz.",
    ...
    loading: "Yükleniyor...",
    panelLapSummary: "Tur Özeti",
    panelBestTheoreticalLap: "En İyi Teorik Tur",
    panelSectorAnalysis: "Sektör Analizi",
    panelSpeedTrace: "Hız İzi",
    panelTyreSurfaceTemp: "Lastik Yüzey Sıcaklığı",
    panelBrakeTemp: "Fren Sıcaklığı",
    panelTyreWear: "Lastik Aşınması",
    panelStintComparison: "Stint Karşılaştırması",
    colLap: "Tur",
    colTime: "Süre",
    colDelta: "Delta",
    colPit: "Pit",
