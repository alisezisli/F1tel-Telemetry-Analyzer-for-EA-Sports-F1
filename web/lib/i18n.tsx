...
const translations = {
  en: {
    ...
    panelThrottleBrake: "THROTTLE & BRAKE",
    panelSteering: "STEERING (- left, + right)",
    panelGearRpm: "GEAR & RPM",
    ...
    sectionLapAnalysis: "LAP ANALYSIS",
  ...
  tr: {
    ...
    panelSpeedTrace: "HIZ",
    panelThrottleBrake: "GAZ & FREN",
    panelSteering: "DİREKSİYON (- sol, + sağ)",
    panelGearRpm: "VİTES & RPM",
    ...
    sectionLapAnalysis: "TUR ANALİZİ",
